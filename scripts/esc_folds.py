...
audio_path = "./esc50/ESC-50-master/audio/"   # path to laod raw esc audio
PATH_data = './esc50/'   # root dir to save the resampled esc audio
meta = np.loadtxt('./esc50/ESC-50-master/meta/esc50.csv', delimiter=',', dtype='str', skiprows=1)
folds = meta[:, 1]
names = meta[:, 3]
labels = meta[:, 2]
...
for fold in [1, 2, 3, 4, 5]:
    ...
    check_dirs.check_dir(PATH_data + 'split_full_dataset/sr_%d/fold%s/' % (target_sr, fold))
