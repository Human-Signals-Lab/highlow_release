...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 22 15:11:45 2023
...
import check_dirs
from models import FineTuneCNN14, FineTuneMBNetV2, FineTuneResNet38
...
for sr in [2000, 1000, 16000]:
    for fold in [1, 2 ,3, 4, 5]:
        ...
        print('{}\t{}\t{}\t{}\t{}\t{}'.format('CNN14FC', fold, f1_stop, precision_stop, recall_stop, confusion), 
                  #file=open('./models/resnet+fc/sr_%d/seg_%ds/resnetFC_ESCdata_50class_result.logs' %(sr, seg_t),'a+')) 
